      ...
      <div class="relative mt-16 mb-16 max-w-sm mx-auto mt-24">
        <div class="rounded overflow-hidden shadow-md bg-white">
          <div class="absolute -mt-20 w-full flex justify-center">
            <div class="h-50 w-50">
              <img src="https://i.imgur.com/4mopFqe.jpeg" class="justify-center rounded-full h-full w-2/3 shadow-md" alt="캐릭터가 없음" />
            </div>
          </div>
          <div class="px-6 mt-16">
            <p class="text-center text-gray-600 text-base pt-3 mb-3 font-normal">
              <br /><br />닉네임 "${nicknameInput.value}"를 찾을 수 없다옹 😿 <br /><br />
            </p>
          </div>
        </div>
      </div>
